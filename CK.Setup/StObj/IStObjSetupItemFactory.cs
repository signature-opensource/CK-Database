...
namespace CK.Setup
{
    ...
    {
        /// <summary>
        /// Creates an <see cref="IMutableDependentItemContainerTyped"/> from a <see cref="IStObjSetupData"/>.
        ...
        /// <returns>A <see cref="IMutableDependentItemContainerTyped"/> implementation that must be correctly initialized by the given data, or null to use the default <see cref="StObjDynamicPackageItem"/>.</returns>
        IMutableDependentItemContainerTyped CreateDependentItem( IActivityLogger logger, IStObjSetupData data );
    }
