...
namespace CK.Setup
{
    public class PackageScriptSetupHandler : SetupHandlerContainer
    {
        readonly PackageScriptSet _scripts;
        readonly IReadOnlyList<IScriptTypeHandler> _scriptHandlers;

        public PackageScriptSetupHandler( SetupDriverContainer driver, PackageScriptSet scripts, IReadOnlyList<IScriptTypeHandler> scriptHandlers )
            : base( driver )
        {
        ...
        class ScriptLine
        {
            public readonly SetupDriverContainer Container;
            public readonly IScriptTypeHandler Handler;
            public readonly PackageTypedScriptVector Vector;

            IScriptExecutor _executor;

            public ScriptLine( SetupDriverContainer container, IScriptTypeHandler h, PackageTypedScriptVector v )
            {
                Container = container;
                Handler = h;
                Vector = v;
