...
namespace CK.Setup
{
    ...
    /// Only those direct dependencies should be used by a setup driver, even if by using the <see cref="SetupCenter"/>, the whole list
    ...
    public abstract class SetupDriverBase
    {
        ...
        internal SetupDriverBase( SetupCenter center, ISortedItem sortedItem, VersionedName externalVersion, ISetupDriverList directDependencies )
        {
            SetupCenter = center;
            ...
            DirectDependencies = directDependencies ?? new DirectList( sortedItem.Requires.Select( d => SetupCenter.Drivers[d] ).OrderBy( d => d.Index ).ToArray() );
        }
        ...
        /// <summary>
        /// The <see cref="SetupCenter"/> to which this driver belongs.
        /// </summary>
        public readonly SetupCenter SetupCenter;

        /// <summary>
        /// The <see cref="IActivityLogger"/> to use.
        /// </summary>
        public IActivityLogger Logger
        {
            get { return SetupCenter.Logger; }
        }
