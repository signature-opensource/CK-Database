...
namespace CK.Setup
{
    public class PackageTypeItem : DynamicPackageItem //, ITypedObjectDependentItem
    {
        readonly Type _itemType;
        readonly PackageAttribute _attr;
        readonly PackageTypeItem _inherited;

        internal protected PackageTypeItem( Type itemType, PackageAttribute attr, string itemTypeName = "PackageType" )
            : base( itemTypeName )
        {
            _itemType = itemType;
            _attr = attr;
        ...
        internal protected PackageTypeItem( Type itemType, PackageAttribute attr, PackageTypeItem inherited, string itemTypeName = "PackageType" )
            : base( itemTypeName )
        {
            _itemType = itemType;
            _attr = null;
        ...
        public PackageAttribute Attribute
        {
            get { return _attr; }
        }

        public PackageTypeItem Inherited
        {
