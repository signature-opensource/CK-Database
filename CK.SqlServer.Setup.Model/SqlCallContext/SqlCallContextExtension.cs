...
namespace CK.SqlServer
{
    ...
    public static class SqlCallContextExtension
    {
        ...
        /// This is simply a more explicit call to the actual indexer: <see cref="ISqlCallContext.Item(string)"/>.
        /// </summary>
        ...
        /// This is simply a more explicit call to the actual indexer: <see cref="ISqlCallContext.Item(ISqlConnectionStringProvider)"/>.
        /// </summary>
        /// <param name="this">This Sql call context.</param>
