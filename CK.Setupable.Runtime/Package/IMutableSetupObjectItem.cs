...
{
    /// <summary>
    /// A mutable version of an <see cref="ISetupItem"/> with only object support (no container
    /// nor generalization are supported at this level).
    ...
    /// </summary>
    public interface IMutableSetupObjectItem : ISetupItem
    { 
        /// <summary>
