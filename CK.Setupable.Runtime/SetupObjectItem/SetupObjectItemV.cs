...
namespace CK.Setup
{
    ...
    public abstract class SetupObjectItemV : SetupObjectItem, IVersionedItem
    {
        ...
        /// </param>
        protected SetupObjectItemV( ContextLocName name, string itemType, Version version = null, IEnumerable<VersionedName> previousNames = null, string containerName = null )
