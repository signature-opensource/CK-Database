...
namespace CK.Setup
{
    ...
    public interface IStObjSetupDynamicInitializer
    {
        ...
        /// If an initializer requires its dependent object to be initialized (for some initializations), it can use the <paramref name="postDependencyActions"/> collector to 
        /// push actions that will be executed in revert order.
        /// </summary>
