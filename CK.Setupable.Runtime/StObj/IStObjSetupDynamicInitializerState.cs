...
namespace CK.Setup
{
    ...
    public interface IStObjSetupDynamicInitializerState
    {
        ...
        /// (either on the <see cref="IStObjSetupDynamicInitializer"/> interface or on a new interface) preciselt because
        /// there is no limit. Since "transformers" and other low level operations are handled by aware developpers ;), 
