...
{
    /// <summary>
    /// Describes a <see cref="IStObjMutableReference"/> that is an injected ambient object: such references are defined by properties 
    /// marked with <see cref="InjectObjectAttribute"/>. The property type is necessarily a <see cref="IAmbientObject"/>
    ...
    public interface IStObjMutableInjectObject : IStObjMutableReference
    {
        ...
        /// </summary>
        /// <remarks>
        /// If this is true, it means that all property definition across the inheritance chain has [<see cref="InjectObjectAttribute">InjectAmbientSingleton</see>( <see cref="IAmbientPropertyOrInjectObjectAttribute.IsOptional">IsOptional</see> = true ]
