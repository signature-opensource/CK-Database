...
namespace CK.Core
{
    ...
    {
        /// <summary>
        /// First method called when an instance of the final type must be instanciated.
        ...
        /// </summary>
        /// <param name="finalType">Final type of the object to create. Can be an automatically generated concrete type that specializes an abstrat one.</param>
