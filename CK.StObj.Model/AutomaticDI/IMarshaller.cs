...
namespace CK.StObj.Model
{
    ...
    public interface IMarshaller<T> where T : IMarshallableAutoService
    {
        /// <summary>
        /// Writes any information to the binary writer that <see cref="Read(ICKBinaryReader)"/> wil use to
