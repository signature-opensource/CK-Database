...
namespace CK.Core
{
    ...
    public interface IAutoImplementorMethod
    {
        ...
        /// (for instance, whenever the method is not ready to be implemented). Any error must be logged into the <paramref name="logger"/>.
        /// </returns>
        bool Implement( IActivityLogger logger, MethodInfo m, IDynamicAssembly dynamicAssembly, TypeBuilder b, bool isVirtual );
    }
