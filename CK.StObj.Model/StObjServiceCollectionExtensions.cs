...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class StObjServiceCollectionExtensions
    {
        ...
        /// </param>
        /// <returns>This services collection.</returns>
        public static IServiceCollection AddStObjMap( this IServiceCollection services, IActivityMonitor monitor, AssemblyName assemblyName, SimpleServiceContainer startupServices = null )
        {
            return services.AddStObjMap( monitor, Assembly.Load( assemblyName ), startupServices );
        }
