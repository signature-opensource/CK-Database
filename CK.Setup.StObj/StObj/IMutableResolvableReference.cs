...
{
    /// <summary>
    /// A resolvable reference is either a <see cref="IMutableParameter"/> or a <see cref="IMutableAmbientProperty"/>.
    /// </summary>
    public interface IMutableResolvableReference : IMutableReference
    {
        /// <summary>
        /// Gets the name of the reference (construct parameter or ambient property name).
        /// </summary>
        string Name { get; }

        /// <summary>
        /// Gets or sets whether the resolution of this reference can be considered as optional.
        /// When changed by <see cref="IStObjStructuralConfigurator"/> from false to true (caution: this means that the ambient property is statically 
