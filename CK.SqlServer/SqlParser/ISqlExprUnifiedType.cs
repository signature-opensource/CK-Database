...
{
    /// <summary>
    /// Unifies Sql types <see cref="SqlExprTypeDateAndTime"/>, <see cref="SqlExprTypeDecimal"/>, <see cref="SqlExprTypeSimple"/>, <see cref="SqlExprTypeWithSize"/>
    /// and <see cref="SqlExprTypeUserDefined"/>.
    /// </summary>
    /// <remarks>
    ...
    /// To make this explicit, our Size/Precision/Scale has been prefixed with 'Syntax'.
    /// </remarks>
    public interface ISqlExprUnifiedType
    {
        /// <summary>
        ...
        /// The precision must be a value from 1 through the maximum precision of 38 (0 when not applicable). 
        ...
        /// <summary>
        /// Gets the fractional seconds precision (actually is the scale) of <see cref="SqlDbType.DateTime2"/> and <see cref="SqlDbType.DateTimeOffset"/>.
