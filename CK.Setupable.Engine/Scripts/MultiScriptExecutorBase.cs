...
namespace CK.Setup
{
    public abstract class MultiScriptExecutorBase : IScriptExecutor
    {
        ...
        public virtual bool ExecuteScript( IActivityMonitor monitor, SetupItemDriver driver, ISetupScript script )
        {
        ...
        /// </returns>
        protected abstract MultiScriptBase CreateMultiScript( IActivityMonitor monitor, SetupItemDriver driver, ISetupScript script );
