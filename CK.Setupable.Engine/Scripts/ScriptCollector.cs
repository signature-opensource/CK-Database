...
/*----------------------------------------------------------------------------
* This file (CK.Setupable.Engine\Scripts\ScriptCollector.cs) is part of CK-Database. 
...
namespace CK.Setup
{
    ...
    public class ScriptCollector : IScriptCollector
    {
        ...
        readonly CKReadOnlyCollectionOnICollection<string> _scriptSourcesEx;
        ...
        public ScriptCollector( ScriptTypeManager typeManager )
        {
            ...
            _scriptSourcesEx = new CK.Core.CKReadOnlyCollectionOnICollection<string>( _scriptSources );
