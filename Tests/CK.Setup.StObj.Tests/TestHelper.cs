...
namespace CK.Setup.StObj.Tests
{
    static class TestHelper
    {
        ...
        private static void InitalizePaths()
        {
            ...
            // Code base is like "file:///C:/Users/Spi/Documents/Dev4/CK-Database/Output/Tests/Debug/CK.Setup.StObj.Tests.DLL"
            ...
            // => CK-Database/
            p = Path.GetDirectoryName( p );
            // ==> Tests/CK.Setup.StObj.Tests/Scripts
            _scriptFolder = Path.Combine( p, "Tests", "CK.Setup.StObj.Tests", "Scripts" );
        }
