...
namespace CK.Setup.Tests.SubNamespace
{
    class OneType
    {
    }
...
namespace CK.Setup.Tests
{
    ...
    class Resources
    {
        ...
        public void ResourceLocationReliesOnDefaultNamespaceOfTheAssembly()
        {
            ...
            {
                ResourceLocator r = new ResourceLocator( typeof( Resources ), "~CK.Setup.Tests.Res" );
                Assert.That( r.GetString( "TextFile.txt", true ), Is.EqualTo( "A content." ) );
            }
            {
                ResourceLocator r = new ResourceLocator( typeof( CK.Setup.Tests.SubNamespace.OneType ), "Sub.Res" );
                Assert.That( r.GetString( "TextFile.txt", true ), Is.EqualTo( "A content 2." ) );
            }
            {
                ResourceLocator r = new ResourceLocator( typeof( CK.Setup.Tests.SubNamespace.OneType ), "~CK.Setup.Tests.SubNamespace.Sub.Res" );
                Assert.That( r.GetString( "TextFile.txt", true ), Is.EqualTo( "A content 2." ) );
            }
        }
        ...
        public void ResourceLocationInAnotherNamespace()
        {
            ...
            {
                ResourceLocator r = new ResourceLocator( typeof( Another.Namespace.OneTypeInAnotherNamespace ), "~CK.Setup.Tests.Another.Namespace" );
