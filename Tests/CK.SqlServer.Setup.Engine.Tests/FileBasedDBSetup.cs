...
namespace CK.SqlServer.Setup.Engine.Tests
{
    ...
    {
        const string dbFromScratch = "Server=.;Database=TEST_FROM_SCRATCH;Integrated Security=SSPI";
        const string dbFromScratchWithView = "Server=.;Database=TEST_FROM_SCRATCH_VIEW;Integrated Security=SSPI";
        ...
        public void InstallPackageWithView()
        {
            ...
            using( var defaultDB = SqlManager.OpenOrCreate( dbFromScratchWithView, TestHelper.ConsoleMonitor ) )
            {
        ...
        public void InstallPackageWithSPDependsOnVersion()
        {
            using( var defaultDB = SqlManager.OpenOrCreate( dbFromScratch, TestHelper.ConsoleMonitor ) )
            {
                ...
                var engine = new SetupEngine( TestHelper.ConsoleMonitor, c, StObjContextRoot.DefaultStObjRuntimeBuilder );

                StObjContextRoot.Build( c, null, TestHelper.ConsoleMonitor ).Dispose();
