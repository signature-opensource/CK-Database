...
namespace CK.Database.Setup.Tests
{
    static class TestHelper
    {
        ...
        private static void InitalizePaths()
        {
            ...
            // Code base is like "file:///C:/Users/Spi/Documents/Dev4/CK-Database/Output/Tests/Debug/CK.Database.Setup.Tests.DLL"
            ...
            _scriptFolder = Path.Combine( p, "Tests", "CK.Database.Setup.Tests", "Scripts" );
        }
