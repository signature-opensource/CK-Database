...
(
  ...
  constraint PK_tActor primary key clustered ( ActorId ) on [PRIMARY]
);
...
(
  ...
  constraint PK_tUser primary key  clustered ( UserId ) on [PRIMARY],
...
insert into CK.tUser ( UserId, UserName, Email ) values ( 0, N'Anonymous', '' );

-- 1 == System user
insert into CK.tActor ( ActorId ) values ( 1 );
insert into CK.tUser ( UserId, UserName, Email ) values ( 1, N'System', '' );
